package team.cqr.cqweaponry.item.armor.colorable;
...
public class ItemArmorDyable extends DyeableArmorItem {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
		if (this.getMaterial() == ArmorMaterial.IRON) {
			return CQWeaponryMod.MODID + ":textures/models/armor/iron_dyable_layer_" + (slot != EquipmentSlotType.LEGS ? 1 : 2) + (type != null ? "_" + type : "") + ".png";
		}
		if (this.getMaterial() == ArmorMaterial.DIAMOND) {
			return CQWeaponryMod.MODID + ":textures/models/armor/diamond_dyable_layer_" + (slot != EquipmentSlotType.LEGS ? 1 : 2) + (type != null ? "_" + type : "") + ".png";
		}
